...
final class FetchComicsUseCaseMock: FetchComicsUseCaseProtocol {
    ...
    static let comicsFirstRequest: [Comic] = {
        let comic1 = Comic(id: 1, title: "X-Men Red", imageUrl: "http://i.annihil.us/X-MenRed.jpg", startDate: "2007")
        let comic2 = Comic(id: 2, title: "S.W.O.R.D", imageUrl: "http://i.annihil.us/S.W.O.R.D.jpg", startDate: "2009")
    ...
    static let comicsSecondRequest: [Comic] = {
        let comic3 = Comic(id: 3, title: "Spiderman", imageUrl: "http://i.annihil.us/Spiderman.jpg", startDate: "1993")
        let comic4 = Comic(id: 4, title: "Avangers", imageUrl: "http://i.annihil.us/Avangers.jpg", startDate: "2004")
